...
const char *keyfile1 = "sshuser_public_key";
const char *keyfile2 = "sshuser_private_key";
const char *username = "hyundai";
const char *password = "";
 
const char *server_ip = "192.168.1.150";
 
const char *local_listenip = "127.0.0.1";
unsigned int local_listenport = 5000;
 
const char *remote_desthost = "192.168.1.200"; /* resolved by the server */ 
unsigned int remote_destport = 3389;
